      ...
      <Card>
        ...
        <CardContent>
          <Alert className="mb-4">
            ...
            <AlertDescription>
              Tài khoản sau khi tạo sẽ có thể đăng nhập vào hệ thống bachungyenone.com theo vai trò được cấp. Mỗi cán bộ cần có email đăng nhập duy nhất.
            </AlertDescription>
          </Alert>
            ...
            <div className="flex items-center justify-between rounded-lg border p-3">
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  Chỉ bật khi đã cấu hình email tên miền bachungyenone.com — khi bật, mật khẩu tạm sẽ không hiển thị mà gửi qua email đặt lại mật khẩu.
                </p>
              </div>
