...
const muc: MucLichSu = {
  ma: '2026-08-29-tang-sao-tren-cong-theo-so-serial',
  ngay: '2026-08-29',
  loai: 'lon',
  phanHe: 'bhy-ways',
  tieuDe: 'Tặng Sao Xứng Đáng ngay trên cổng — mỗi số serial chỉ dùng một lần',
  tomTat:
    'Trang Sao Xứng Đáng giờ là nơi ghi nhận Sao trực tiếp: lãnh đạo chọn cán bộ '
    + 'từ danh bạ, chọn số serial trong số sao mình được bàn giao, hệ thống tự '
    + 'điền người tặng theo tài khoản. Hai lần dữ liệu bị trùng số sao trước đây '
    + 'đều do gõ tay — nay số chỉ chọn từ sổ, trùng là máy từ chối ngay.',
  diemChinh: [
