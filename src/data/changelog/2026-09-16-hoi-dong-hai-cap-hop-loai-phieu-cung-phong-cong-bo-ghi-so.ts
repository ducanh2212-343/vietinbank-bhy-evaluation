...
const muc: MucLichSu = {
  ma: '2026-09-16-hoi-dong-hai-cap-hop-loai-phieu-cung-phong-cong-bo-ghi-so',
  ngay: '2026-09-16',
  loai: 'lon',
  phanHe: 'bhy-ways',
  tieuDe: 'Hội đồng: công bố là ghi sổ thưởng; loại phiếu cùng phòng; hai cấp họp tách bạch',
  tomTat:
    'Sau đợt Hội đồng đầu tiên, Giám đốc chốt bốn luật vận hành. Công bố kết quả nay tự ghi sổ '
    + 'thưởng, nâng cấp độ ý tưởng và báo cho chủ ý tưởng — giống lúc Giám đốc duyệt Bén rễ. Phiếu '
    + 'của thành viên cùng phòng (hoặc phòng có cán bộ đồng đề xuất) bị loại khỏi điểm và mẫu số, '
